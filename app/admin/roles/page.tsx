...
export default function RolesPage() {
    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in-up pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {roles.map(role => (
        <div key={role.id} className="card-glass p-8 flex flex-col hover:scale-[1.02] transition-all duration-300">
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="w-12 h-12 rounded-full bg-teal-50 dark:bg-teal-900/20 flex items-center justify-center text-teal-600 dark:text-teal-400 shadow-sm">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-700/50 flex justify-end">
                ...
                className="flex items-center space-x-2 text-slate-600 hover:text-teal-600 dark:text-slate-400 dark:hover:text-white font-bold text-sm transition-colors group"
                            >
        ...
        <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 bg-slate-50/50 dark:bg-slate-900/50 p-4 rounded-3xl border border-slate-100 dark:border-slate-800">
                    ...
                    <div className="flex items-center space-x-2">
                                            <Icon className={`w-4 h-4 ${isChecked ? 'text-teal-600 dark:text-teal-400' : 'text-slate-400'}`} />
