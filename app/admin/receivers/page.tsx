                            ...
                            <button
                                ...
                                onClick={async () => {
                                    ...
                                    setRescreenParams({
                                        ...
                                        dob: String((receiver as any)?.dob || (receiver as any)?.date_of_birth || ''),
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        const res = await fetch(
                                            withActingUserParam(
                                                ENDPOINTS.BENEFICIARIES.DILISENSE_REPORT_GENERATE(reportsModal.selectedId!),
                                                currentUser
                                            ),
                                            {
                                                method: 'POST',
                                        ...
                                        if (res.ok) {
                                            const listRes = await fetch(
                                                withActingUserParam(
                                                    ENDPOINTS.BENEFICIARIES.DILISENSE_REPORTS_LIST(reportsModal.selectedId!),
                                                    currentUser
                                                )
                                            );
                                            const listData = await listRes.json().catch(() => []);
                                            ...
                                            if (newReportId) {
                                                void openPdfReport(
                                                    withActingUserParam(
                                                        ENDPOINTS.BENEFICIARIES.DILISENSE_REPORT_DOWNLOAD(reportsModal.selectedId!, newReportId),
                                                        currentUser
                                                    ),
                                                    currentUser,
                                                    pdfWindow
