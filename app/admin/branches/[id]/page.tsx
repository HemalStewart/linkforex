                ...
                <fieldset disabled={isReadOnly} className="space-y-6 block">
                    <SectionCard title="Branch Details" description="Core location and branch identity information.">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <TextField label="Address" value={formData.address_line_1} onChange={(value) => updateField('address_line_1', value)} placeholder="Enter branch address" icon={<MapPin className="h-5 w-5" />} required disabled={isReadOnly} />
                            <TextField label="City" value={formData.city} onChange={(value) => updateField('city', value)} placeholder="Enter city" icon={<Building className="h-5 w-5" />} required disabled={isReadOnly} />
                            <TextField label="Post Code" value={formData.postcode} onChange={(value) => updateField('postcode', value)} placeholder="Enter post code" icon={<MapPin className="h-5 w-5" />} required disabled={isReadOnly} />
                            <SelectField label="Country" value={formData.country} onChange={(value) => updateField('country', value)} icon={<Flag className="h-5 w-5" />} required disabled={isReadOnly}>
                    ...
                    <SectionCard title="Contact Section" description="Primary and secondary contact details for this branch.">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <TextField label="Primary Contact" value={formData.telephone_1} onChange={(value) => updateField('telephone_1', value)} placeholder="Enter primary contact number" icon={<Phone className="h-5 w-5" />} required disabled={isReadOnly} />
