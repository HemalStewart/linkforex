...
export default function SettingsPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-fade-in-up pb-20">
            ...
            {message && (
                <div className="p-4 rounded-xl bg-emerald-50 text-emerald-700 border border-emerald-100 flex items-center shadow-lg shadow-emerald-500/10 animate-fade-in-down">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="card-glass p-4 rounded-[2rem] sticky top-8">
                ...
                <div className="lg:col-span-3 space-y-6">
                    {activeTab === 'general' && (
                        <div className="card-glass p-8 rounded-[2.5rem] animate-scale-in">
                        ...
                        <div className="card-glass p-8 rounded-[2.5rem] animate-scale-in">
                            ...
                            <div className="space-y-6 max-w-2xl">
                                <div className="flex items-center space-x-6 mb-8">
                                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-3xl font-bold shadow-xl shadow-indigo-500/20">
                                ...
                                <div className="p-6 rounded-3xl bg-indigo-50/50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-800">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <h3 className="font-bold text-indigo-900 dark:text-indigo-100">Two-Factor Authentication</h3>
                                        </div>
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            <input
                                                type="checkbox"
