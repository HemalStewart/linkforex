        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-fade-in-up pb-20">
            ...
            {viewOverviewRemitter && (
                <RemitterOverviewModal
                    remitter={viewOverviewRemitter}
                    receivers={overviewReceivers}
                    onClose={() => setViewOverviewRemitter(null)}
                    onOpenDocuments={(r) => setDocModal({ isOpen: true, remitterId: r.id, remitterName: r.sender_name || r.name || '' })}
                />
            )}
        </div>
    );
