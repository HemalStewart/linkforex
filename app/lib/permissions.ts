...
export const ADMIN_PAGES_CONFIG: AdminCategoryInfo[] = [
    ...
    },
    {
        ...
        pages: [
            ...
            { name: 'Branch Access', section: 'BRANCH_ACCESS_REQUESTS', operations: ['VIEW', 'APPROVE', 'CANCEL', ...AUDIT_OPS] },
    ...
    },
    {
        ...
        pages: [
            ...
            { name: 'Screening Quotas', section: 'API_TOKEN_QUOTAS', operations: ['VIEW', 'EDIT'] },
    ...
    },
    {
        ...
        pages: [
            ...
            { name: 'Profile Review Queue', section: 'MOBILE_PROFILE_REVIEW_QUEUE', operations: ['VIEW', 'APPROVE', 'CANCEL', 'PDF', ...AUDIT_OPS] },
            { name: 'Campaigns', section: 'MOBILE_CAMPAIGNS', operations: ['VIEW', 'CREATE', 'EDIT', 'DELETE', ...AUDIT_OPS] },
            { name: 'Onboarding & Carousel', section: 'MOBILE_ADS', operations: ['VIEW', 'CREATE', 'EDIT', 'DELETE', 'DISABLE', ...AUDIT_OPS] }
            ,{ name: 'Wallet Transfers', section: 'MOBILE_WALLET_TRANSFERS', operations: ['VIEW', 'EDIT', ...AUDIT_OPS] }
        ]
    },
    {
        ...
        pages: [
            ...
            { name: 'Occupations', section: 'OCCUPATIONS', operations: ['VIEW', 'CREATE', 'EDIT', 'DELETE', ...AUDIT_OPS] }
        ]
    },
    {
...
export function usePagePermissions(section: string) {
    ...
    useEffect(() => {
        const update = () => {
            ...
            const hasDeleteComplianceReport = checkPermission(section, 'DELETE_COMPLIANCE_REPORT') || checkPermission(section, 'DELETE_REPORTS');
            const hasUploadReports = checkPermission(section, 'UPLOAD_REPORTS') || checkPermission(section, 'UPLOAD_REPORT');
            ...
            setPerms({
                ...
                canDeleteReports: hasDeleteComplianceReport,
                canUploadReports: isOpConfigured('UPLOAD_REPORTS') ? hasUploadReports : (hasUploadReports || hasCreate),
